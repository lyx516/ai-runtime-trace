...
SQLite at PROJECT_ROOT/.hermes-flow/memory.sqlite
...
def _get_db_path() -> Path:
    ...
    if _DB_PATH is not None:
        return _DB_PATH
    # Resolve from env or fall back to script_dir/.hermes-flow/memory.sqlite
    root = Path(__file__).resolve().parent.parent  # ai-runtime-trace/
    _DB_PATH = root / ".hermes-flow" / "memory.sqlite"
