"""Hermes Flow analysis CLI — analyze, diff, budget, and export commands.

Usage:
    python -m hermes_flow.cli.analyze <run_id> [--json]
    python -m hermes_flow.cli.analyze diff <run_id_a> <run_id_b>
    python -m hermes_flow.cli.analyze budget <run_id>
"""
...
from hermes_flow.observer import _find_runs_dir, _get_store
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Hermes Flow analysis CLI",
...
Examples:
  ...
  python -m hermes_flow.cli.analyze budget <run_id>
    ...
    if ns.command:
        ...
        # Legacy mode: python -m hermes_flow.cli.analyze <run_id>
