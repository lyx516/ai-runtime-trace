...
Usage:
    python -m runtime_trace.benchmark
    python -m runtime_trace.benchmark --agent-count 5
"""
...
def run_agent_session_simulated(
    ...
    from runtime_trace.trace import get_tracer, set_tracer, SqliteTracer, NoOpTracer
...
def run_benchmark(agent_count: int = 3) -> dict[str, Any]:
    ...
    tmpdir = tempfile.mkdtemp(prefix="runtime-trace-benchmark-")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Runtime Trace Benchmark")
    parser.add_argument(
