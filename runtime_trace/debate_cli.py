...
Set --workdir to override, or set RUNTIME_TRACE_PROJECT_ROOT env var.
"""
...
def resolve_project_root() -> str:
    ...
    return os.environ.get("RUNTIME_TRACE_PROJECT_ROOT") or str(Path(__file__).resolve().parent.parent)
...
def main():
    ...
    os.environ.setdefault("RUNTIME_TRACE_RUNS_DIR", str(repo_root / ".runtime-trace" / "runs"))
