"""Canonical filesystem locations for Hermes Flow runtime stores."""
...
RUNS_DIR_ENV = "HERMES_FLOW_RUNS_DIR"
PROJECT_ROOT_ENV = "HERMES_FLOW_PROJECT_ROOT"
...
def get_runs_dir(project_root: str | Path | None = None, *, create: bool = False) -> Path:
    ...
    HERMES_FLOW_RUNS_DIR pins all runs to one fixed location.  If it is not
    set, runs remain project-local under <project-root>/.hermes-flow/runs.
    """
