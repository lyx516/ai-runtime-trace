...
from runtime_trace.hooks import (
    Hook,
    HookHandler,
    install_observer_bridge,
    subscribe,
)
from runtime_trace.schemas import Decision
...
def _register_persistence_handlers(store: RuntimeStore, run_id: str) -> None:
    ...
    from runtime_trace.hooks import get_bus as _get_bus
...
def bootstrap_runtime(
    ...
    *,
    ...
    if enable_observer:
        from runtime_trace.observer import ensure_observer, get_event_bus
