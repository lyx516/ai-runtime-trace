"""Typed exception classes for the Runtime Trace FSM."""

from typing import Optional


class FlowError(Exception):
    """Base exception for all Runtime Trace errors."""
...
class WorkerExecutionError(FlowError):
    """Raised when a Runtime Trace worker session/profile execution fails."""
